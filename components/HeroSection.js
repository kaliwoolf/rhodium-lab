...
export default function HeroSection() {
  ...
  // Анимации кнопки
  const y = useTransform(scrollY, [0, 300], [0, 0]) // без движения
  const opacity = useTransform(scrollY, [0, 300], [1, 1]) // не исчезает
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center text-white font-sans z-10">
      ...
      {/* Обёртка с sticky — она красиво прилипает и "отлипа́ет" */}
      <div className="sticky top-6 z-50 w-full flex justify-center mt-12">
        <motion.div
          style={{ y, opacity }}
